---
_id: c8bc8130-5c42-11f1-b307-b98ec334f62e
status: searching
...
role: Logo design
compensation: gratis
deliverables: Logo in SVG format. Huge bonus if this is a single shape (path).
how_to_apply:
...
Preferably, the created logo would be under a Creative Commons license. CC-0, CC-BY, or CC-BY-SA (the last is used by the project).
